...
I originally went with IBM Plex Sans after a lot of experimenting but came across this [beautiful blog post](https://angristan.xyz/build-push-docker-images-gitlab-ci/) and was surprised to see it used the Source Sans Pro font. Why didn't it look good when I tried it? Apparently, there's a property called font-smoothing that makes quite a big difference and is used on the Google Fonts website and medium. There's a bit of [controversy](https://github.com/google/fonts/issues/1170) around it but it does look nicer in my opinion.

I also removed TypographyJS that comes with the Gatsby Starter pack in favour of the simpler classic, [Bootstrap Reboot](https://getbootstrap.com/docs/4.1/content/reboot/).
