...
My most recent role was Senior Frontend Engineer at Canva. I worked on the SEO Growth Engineering team and delivered authentication features on landing pages like the [PDF to PPT Converter](https://www.canva.com/features/pdf-to-ppt-converter/) page.

I led the Authentication and Authorisation team at Linktree for over a year, delivering features for both users and engineers. For users, we delivered an OAuth page with multi-factor authentication for a single, secure authentication flow across web and mobile apps. For engineers, we built secure communication tools to enable teams to build and own their own services, replacing the current, monolithic authentication process.

I also led a team at Damstra Technology. I was working for a startup called Velpic when Damstra Technology acquired Velpic in 2018. I was the only engineer to come across and was tasked with responsibilities previously shared by a team of ten people, including product management, infrastructure, feature development and customer support. I built and led an engineering team for the first time in my three year career and, within a year, we had a healthy team of three engineers and stable product. Infrastructure was key to our success. I worked on a distributed email queue, Kinesis data streaming pipeline and Kubernetes cluster to improve reliability and developer experience.
...
- Writing design documents in collaboration with other teams.
- Improving team culture and processes.
- Mentoring.
...
We delivered security features to users and platform tools to engineers. For users, we delivered an OAuth page with multi-factor authentication using Auth0 and authorisation code flow, providing a single authentication flow for users across web and mobile apps. For engineers, we built secure communication tools for client to service and service to service communication, enabling them to build and own their own services.
